...
public class CreateAccountControllerTest extends ApplicationTest {
    ...
    public void testEmail(){
        ...
        Assert.assertEquals("Please type a valid email", c1.errorLabel.getText());
    ...
    public void testName(){
        ...
        c1.handleCreateAccountButton();
        Assert.assertEquals("Complete your name", c1.errorLabel.getText());
        System.out.println("ok");
    }
    ...
    public void testPassword(){
        ...
        c1.handleCreateAccountButton();
        Assert.assertEquals("Please type your password", c1.errorLabel.getText());
        System.out.println("ok");
    }
    ...
    public void testRegNumber(){
        ...
        c1.handleCreateAccountButton();
        Assert.assertEquals("Please type car registration number", c1.errorLabel.getText());
        System.out.println("ok");
    }
